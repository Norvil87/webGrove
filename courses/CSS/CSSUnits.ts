      ...
      tasks: [
        {
          id: 1,
          label:
            "Контенейру с классом <code>unit-px</code> установите ширину <code>width</code> со значением <code>200px</code>.",
 ...
 `,
      ...
      tasks: [
        ...
        },
        {
          id: 2,
          label:
            "Элементам списка, вложенным в список с классом <code>unit-em</code> задайте размер шрифта в <code>1.2</code> раза больше размера шрифта родительского элемента.",
      ...
      tasks: [
        {
          id: 1,
          label:
            "Элементу с классом <code>unit-percent</code> задайте ширину <code>60%</code> ширины родительского элемента.",
        ...
        },
        {
          id: 2,
          label:
            "Обертке, элементу с классом <code>wrapper</code> измените ширину на <code>80%</code> ширины родительского элемента. Посмотрите, как изменится при этом ширина вложенных элементов",
      ...
      tasks: [
        {
          id: 1,
          label:
            "Элементу с классом <code>unit-vw</code> задайте ширину <code>70%</code> ширины вьюпорта. Обратите внимание, что элемент занял 70% не от всего окна вышего браузера, а только от ширины окна с результатами задания. Это связано с тем, что вывод результатов задания осуществляется в элемент <code>iframe</code>, который технически является отдельным окном со своим вьюпортом.",
      ...
      tasks: [
        {
          id: 1,
          label:
            "Элементу с классом <code>named-color</code> задайте цвет фона 'туманная роза' (<code>mistyrose</code>).",
 ...
 `,
      ...
      tasks: [
        ...
        },
        {
          id: 3,
          label:
            "Элементу с классом <code>rgba-color</code> задайте цвет фона со следующими характеристиками: <ul><li>красный канал - <code>103</code></li><li>зеленый канал - <code>75</code></li><li>синий канал - <code>60</code></li><li>непрозрачность - <code>70%</code></li></ul>.",
 ...
 `,
      ...
      tasks: [
        ...
        },
        {
          id: 3,
          label:
            "Элементу с классом <code>hsla-color</code> задайте цвет фона со следующими характеристиками: <ul><li>основной оттенок - <code>220</code></li><li>насыщенность - <code>85%</code></li><li>осветленность - <code>50%</code></li><li>непрозрачность - <code>40%</code></li></ul>.",
      ...
      tasks: [
        {
          id: 1,
          label:
            "В шапке страницы создайте элемент link, который загрузит шрифт 'Lato' со следующего адреса: <i>'https://fonts.googleapis.com/css2?family=Lato:ital@1&display=swap'</i>.",
 ...
 `,
      ...
      tasks: [
        ...
        },
        {
          ...
          failMsg:
            "Убедитесь, что вы перечислили все свойства в @font-face. Также обратите внимание на порядок перечисления форматов шрифтов",
        },
      ],
    },
  ],
