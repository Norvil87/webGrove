...
.sans-serif {
 ...
 `,
            ...
            tasks: [
                {
                    id: 1,
                    label: "Абзацу с классом <code>serif</code> задайте <code>Georgia</code> в качестве основного шрифта, <code>Times New Roman</code> в качестве вэб-безопасного, <code>serif</code> в качестве семейства шрифтов. Не забудьте про двойные кавычки если название шрифта состоит из нескольких слов.",
...
.sans-serif {
 ...
 `,
            ...
            tasks: [
                ...
                {
                    id: 3,
                    label: "Абзацу с классом <code>large-font</code> задайте размер шрифта в 1.8 раза больше размера шрифта корневого документа.",
...
.sans-serif {
 ...
 `,
            ...
            tasks: [
                ...
                {
                    id: 4,
                    label: "Абзацу с классом <code>color-hsl</code> задайте цвет <code>hsl(34, 44%, 69%)</code>. Да, это все один и тот же цвет.",
...
.sans-serif {
 ...
 `,
            ...
            tasks: [
                {
                    id: 1,
                    label: "Абзацу с классом <code>simple-shadow</code> задайте тень со следующими свойствами: <ul><li>смещение справо на 2px</li><li>смещение вниз на 4px</li></ul>.",
                ...
                {
                    id: 2,
                    label: "Абзацу с классом <code>blurred-shadow</code> задайте тень со следующими свойствами: <ul><li>смещение влево на 5px</li><li>смещение вверх на 5px</li><li>размытие 2px</li><li>цвет #d55813</li></ul>.",
...
`,
            ...
            tasks: [
                {
                    id: 1,
                    label: "Абзацу с классом <code>broad-space</code> задайте интервал между символами в словах <code>3px</code>.",
...
`,
            ...
            tasks: [
                {
                    id: 1,
                    label: "Нумерованному списку задайте тип цифр <code>upper-roman</code> и внутреннее положение маркеров - значение <code>inside</code>.",
