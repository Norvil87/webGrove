      ...
      tasks: [
        {
          ...
          testFn: `const spans = iframe.ownerDocument.querySelector(".monaco-editor").querySelectorAll("span");
      ...
      tasks: [
        {
          ...
          testFn: `const a = iframe.contentDocument.body.querySelector("a");
            return (
              a &&
      ...
      tasks: [
        {
          ...
          testFn: `const a = iframe.contentDocument.body.querySelectorAll("a")[1];
            return (
              a &&
              a.children &&
              a.children.length === 1 &&
      ...
      tasks: [
        {
          ...
          testFn: `const anchor = Array.from(iframe.contentDocument.body.querySelectorAll("a")).find(
      ...
      tasks: [
        {
          ...
          testFn: `const ul = iframe.contentDocument.body.querySelector("h1").nextElementSibling;
            return (
              ul &&
              ul.children &&
        ...
        },
        {
          ...
          testFn: `const firstLi = iframe.contentDocument.body.querySelectorAll("ul")[0].firstElementChild;
        ...
        },
        {
          ...
          testFn: `const secondLi = iframe.contentDocument.body.querySelectorAll("ul")[0].lastElementChild;
      ...
      tasks: [
        {
          ...
          testFn: `const h1 = iframe.contentDocument.body.querySelector("h1");
            return h1 !== null;`,
