      ...
      tasks: [
        {
          ...
          testFn: `const p = iframe.contentDocument.body.querySelector("p");
      ...
      tasks: [
        {
          ...
          testFn: `const divs = iframe.contentDocument.body.querySelectorAll("div");
        ...
        },
        {
          ...
          testFn: `const secondDiv = iframe.contentDocument.body.querySelectorAll("div")[1];
            return (
              secondDiv &&
              secondDiv.children &&
      ...
      tasks: [
        {
          ...
          testFn: `const headers = iframe.contentDocument.body.querySelectorAll("h2");
        ...
        },
        {
          ...
          testFn: `const secondH2 = iframe.contentDocument.body.querySelectorAll("h2")[1];
            return (
              secondH2 &&
        ...
        },
        {
          ...
          testFn: `const h3 = Array.from(iframe.contentDocument.body.querySelectorAll("h3")).find(
      ...
      tasks: [
        {
          ...
          testFn: `const firstDiv = iframe.contentDocument.body.querySelectorAll("div")[0];
            return (
              firstDiv &&
      ...
      tasks: [
        {
          ...
          testFn: `const museumH3 = iframe.contentDocument.body.querySelectorAll("h3")[0];
            return (
              museumH3 &&
        ...
        },
        {
          ...
          testFn: `const theaterH3 = iframe.contentDocument.body.querySelectorAll("h3")[1];
            return (
              theaterH3 &&
        ...
        },
        {
          ...
          testFn: `const span = iframe.contentDocument.body.querySelector("span");
      ...
      tasks: [
        {
          ...
          testFn: `const em = iframe.contentDocument.body.querySelectorAll("em")[1];
        ...
        },
        {
          ...
          testFn: `const strong = iframe.contentDocument.body.querySelectorAll("strong")[1];
      ...
      tasks: [
        {
          ...
          testFn: `const br = iframe.contentDocument.body.querySelector("br");
            return (
              br &&
              br.nextSibling &&
        ...
        },
        {
          ...
          testFn: `const hr = iframe.contentDocument.body.querySelector("hr");
            return (
              hr &&
              hr.previousSibling &&
      ...
      tasks: [
        {
          ...
          testFn: ` const ul = iframe.contentDocument.body.querySelector("ul");
            return ul !== null;`,
      ...
      tasks: [
        {
          ...
          testFn: `const ol = iframe.contentDocument.body.querySelector("ol");
            return !!ol;`,
      ...
      tasks: [
        {
          ...
          testFn: `const leisureElem = iframe.contentDocument.body.querySelector("#leisure");
            return (
              leisureElem &&
        ...
        },
        {
          ...
          testFn: `const bigHeader = iframe.contentDocument.body.querySelector(".big-header");
            return (
              bigHeader &&
      ...
      tasks: [
        {
          ...
          testFn: `const secondImg = iframe.contentDocument.body.querySelectorAll("img")[1];
            return (
              secondImg &&
