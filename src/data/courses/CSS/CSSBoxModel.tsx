...
export const CssBoxModel: ICourseLesson = {
  id: 4,
...
<p>Когда в уроке по единицам измерения CSS мы задавали цвет фону параграфа, то соответствующим цветом окрашивалась не только область непосредственно под текстом, а гораздо большая. То есть очевидно, сам текст не единственная составляющая размера параграфа.</p>
<p>Так и есть, текст - это только контент (<i>content</i>) параграфа. Мы можем представить себе параграф (или другой HTML элемент) как прямоугольную коробку (<i>box</i>), в которой живет контент. Именно коробке с контентом мы и задаем размеры - щирину и высоту:</p>
...
<p style="color: red; width: 250px; height: 100px; background-color: #9abfe2;">Это контент элемента</p>
<p>Мы задали "коробке" парагрфа ширину 250px и высоту 100px, а текст "Это контент элемента" - это контент парагрфа. Размеры можно задавать большинством абсолютных и относительных единиц из урока про единицы измерения CSS, мы для простоты будем использовать пиксели.</p>
<p>Такой подход к HTML элементам как к "коробкам", в которых живет контент называется "коробочной моделью" (<i>box model</i>) и это одна из важнейших концепций в вэб-разработке. Позже мы узнаем, что еще есть в коробке кроме контента.</p>
...
.share a:hover {
  ...
  color: rgb(0, 188, 212);
      ...
      tasks: [
        {
          ...
          failMsg: "Убедитесь, что вы задали правильное значение height контейнеру",
        },
        {
          id: 2,
          label:
            "Заголовку первого уровня, вложенному в <code>header-wrapper</code> установите ширину <code>400px</code>.",
...

    {
      ...
      header: "Рамка - border",
      url: "css-border",
      theory: `<p>Рассмотрим остальные составляющие коробочной модели:</p>
<div><img src="https://sabe.io/classes/css/css-box-model-padding-border-margin/css-box-model.png" alt="css-box-model"></div>
<p>Кроме контента, которому мы задали ширину и высоту, есть еще 3 составляющие - рамка, а также внутренние отступы - паддинги и внешние отступы - маргины. Рамка - это то, что отделяет контент элемента от внешнего содержимого страницы. По-умолчанию она у элемента отсутствует, но ее можно создать с помощью свойства <code>border</code>:</p>
...
<p style="color: red; width: 250px; height: 100px; background-color: #9abfe2; border: 5px solid #fff4c3;">Это контент элемента шириной 250px + рамка 10px</p>
<p>Мы создали рамку шириной 5px, отображаемую сплошной линией цвета #fff4c3. Рамку можно стилизовать, но это тема отдельного урока, сейчас главное, что рамка - часть box-model. Обратите еще раз внимание на схеме, что толщина рамки не входит в ширину и высоту элемента, эти свойства задаются для контента.</p>
<p>Это значит, что рассчитать пространство по ширине, которое элемент занимает на странице, можно так: 250px(ширина контента) + 5*2px(рамка слева и справа) = 260px.</p>
      ...
      tasks: [
        {
          id: 1,
          label:
            "Блоку с классом <code>.share</code> задайте рамку сплошной линией толщиной 3px такого же цвета, как фон ссылок этого блока.",
        ...
        },
        {
          ...
          failMsg: "Убедитесь, что вы задали не пустое значение border",
        },
      ],
    },
...
<p style="padding: 10px 30px; color: red; width: 250px; height: 100px; background-color: #9abfe2; border: 5px solid #fff4c3;">Это контент элемента шириной 250px + рамка 10px + внутренний отступ 60px</p>
<p>Мы задали паддинг сверху и снизу по 10px, а справа и слева по 30px. Обратите внимание, как сместился текст.</p>
<p>Паддинги тоже не входят в ширину и высоту элемента, поэтому придется продолжить расчет места, которое занимает элемент по горизонтали: 250px(ширина контента) + 5*2px(рамка слева и справа) + 30*2px(паддинг слева и справа) = 320px.</p>
<p>Если станете забывать, что входит в box-model элемента, не стесняйтесь вернуться назад и посмотреть схему.</p>
      ...
      tasks: [
        {
          id: 1,
          label:
            "Блоку с классом <code>.share</code> задайте верхний и нижний внутренние отступы по 15px, левый и правый - по 5px.",
          testRegExp: [
...
<p>В такой форме записи первре значение определяет <b>верхний и нижний</b> паддинги, а второе -  <b>левый и правый</b>. В данном случае верхний и нижний отступы у нас равны 10px, левый и правый - 30px. Может звучать слегка путанно поначалу, но используются такие формы записи настолько часто, что вы быстро привыкнете. Наконец:</p>
...
.share a:hover {
  ...
  color: rgb(0, 188, 212);
      ...
      tasks: [
        {
          id: 1,
          label: "Блоку с классом <code>.share</code> задайте паддинги в максимально сокращенной форме.",
        ...
        },
        {
          id: 2,
          label:
            "Заголовку первого уровня, вложенному в <code>header-wrapper</code> задайте паддинги в максимально сокращенной форме.",
...

    {
      ...
      url: "css-margin",
      theory: `<p>Четвертый и последний компонент box-model - это внешние отступы, маргины. Внешний отступ начинается от рамки элемента, это то, как далеко элемент отталкивает от себя другие элементы</p>
...
<p style="margin: 25px 10px; padding: 10px 30px; color: red; width: 250px; height: 100px; background-color: #9abfe2; border: 5px solid #fff4c3;">Это контент элемента шириной 250px + рамка 10px + внутренний отступ 60px</p>
...
<p>Плюс запись одним значением если маргины одинаковы со всех сторон.</p>
      ...
      tasks: [
        {
          id: 1,
          label:
            "Элементам списка <code>li</code>, вложенным в блок с классом <code>navigation</code> задайте внешний отступ снизу <code>10px</code>. Посмотрите, как меняется вертикальное расстояние между элементами",
        ...
        },
        {
          id: 2,
          label:
            "Блоку с классом <code>.share</code> задайте внешний отступ <code>1rem</code> сверху и снизу и <code>2rem</code> справа и слева.",
...
<p style="margin: 0 auto; margin-bottom: 25px; padding: 10px 30px; color: red; width: 250px; height: 100px; background-color: #9abfe2; border: 5px solid #fff4c3;">Это контент элемента шириной 250px + рамка 10px + внутренний отступ 60px</p>
...
<p>Важным моментом является то, что элементу, которому задано значение <code>margin: 0 auto;</code> также обязательно должна быть задана ширина. Что будет, если ширина не будет задана?</p>
...
<p style="margin: 0 auto; margin-bottom: 25px; padding: 10px 30px; color: red; height: 100px; background-color: #9abfe2; border: 5px solid #fff4c3;">Это контент элемента шириной 250px + рамка 10px + внутренний отступ 60px</p>
<p>Да, <b>Если ширина не задана явно, дочерний элемент растягивается на всю ширину своего родителя</b>. По этой причине центрирование просто не имеет смысла. Дочерний и родительский элемент имеют одинаковую ширину.</p>
 `,
...
.share a:hover {
  ...
  color: rgb(0, 188, 212);
      ...
      tasks: [
        {
          id: 1,
          label:
            "Центрируйте заголовок первого уровня, вложенный в блок с классом <code>header-wrapper</code>. Убедитесь, что заголовку задана ширина.",
          testRegExp: [/.header-wrapper h1\s+{[\s\S]*margin: 0 auto;[\s\S]*}/],
          failMsg: "Убедитесь, что вы задали значение маргина и что блоку задана ширина",
        },
        {
          id: 2,
          label:
            "Центрируйте блок с классом <code>content</code> задайте внешний отступ <code>1rem</code> сверху и снизу и <code>2rem</code> справа и слева.",
...

    {
      ...
      theory: `<p>Большинство браузеров имеют собственные стилевые листы т. н. <em>user agent stylesheets</em>. Правила из них применяются к элементам в случае отсутствия внешнего стилевого листа. Это так же касается внутренних и внешних отступов.</p>
      <p>Для разработчика данный факт является не удобным, поскольку осложняет контроль за отступами - надо держать в голове, какие отступы есть у элементов по умолчанию (к тому же у разных браузеров они разные). Хорошей практикой является сначала сбросить отступы по умолчанию:</p>
...
<p>Мы обнулили все отступы у элемента <code>body</code>, соответственно, они также обнулились у всех вложенных в него элементов, и вот после этого можно задавать конкретные отступы конкретным элементам.</p>
 `,
...
.share a:hover {
  ...
  color: rgb(0, 188, 212);
...

    {
      ...
      theory: `<p>Контент вашей страницы может отображаться на различных устройствах с разной высотой и шириной экрана, поэтому есть дополнительные свойства для контроля ширина/высоты элемента. Свойства <code>min-width</code> и <code>min-height</code> зададут минимальную ширину и высоту элемента.</p>

<pre><code><span class="selector">p</span> {
  <span class="rule">min-height:</span> 100px;
  <span class="rule">min-width:</span> 200px;
}</code></pre>

<p>Давайте посмотрим, как работают эти свойства. При изменении ширины экрана будет меняться ширина параграфа, но не при каких обстоятельствах она не станет меньше 100px (подстраховка от того, что параграф станет слишком узким, а текст в нем - нечитаемым). Высота параграфа равна высоте контента, но не меньше 200px.</p>
<p>Вообще элементам, содержащим текстовый контент, рекомендуют вместо фиксированной высоты задавать именно минимальную высоту. Это позволяет решить проблему "переполнения" контентом.</p>
...
`,
      goal: `Добавьте элементам минимальную ширину и высоту.`,
      initValues: {
        html: `<!--HTML редактор-->
...
.share a:hover {
  ...
  color: rgb(0, 188, 212);
      ...
      tasks: [
        {
          id: 1,
          label:
            "Всем параграфам на странице установите минимальную ширину <code>350px</code>. Измените ширину окна браузера и убедитесь, что ширина параграфов не становится меньше этого значения. Зеленая рамка задана для визуального удобства.",
        ...
        },
        {
          id: 2,
          label:
            "Всем параграфам на странице установите минимальную высоту <code>100px</code>. В HTML редакторе создайте еще один параграф с любым текстом и убедитесь, что минимальная высота действует.",
...

    {
      ...
      theory: `<p>Похожие свойства <code>max-width</code> и <code>max-height</code> позволяют контролировать максимальную ширину и высоту элемента.</p>
...
<p>Параграф ни при каких обстоятельствах не станет выше 500px и шире 80% своего родительского элемента.</p>
<p>Эти свойства являются страховкой от слишком большого количества контента, когда требуется, например, чтобы элемент всегда целиком находился в области видимости, вне зависимости от количества контента, которое его наполняет.</p>
<p>Если элементу заданы все 3 свойства, определяющие его высоту или ширину, то они взаимодействуют друг с другом так: свойство <code>min-width</code> перезаписывает <code>max-width</code>, которое в свою очередь перезаписывает <code>width</code>. То есть если у вас минимальная ширина элемента равна 100px, а максимальная - 50px, фактически элемент не будет уже 100px. Аналогично для высоты.</p>
<p>Также вы можете сбросить свойства <code>max-width</code>, <code>max-height</code>, <code>min-width</code>, <code>min-height</code> с помощью ключевого слова <code>none</code>.</p>
...
`,
      goal: `Добавьте элементам максимальную ширину и высоту.`,
      initValues: {
        html: `<!--HTML редактор-->
...
.share a:hover {
  ...
  color: rgb(0, 188, 212);
      ...
      tasks: [
        {
          id: 1,
          label:
            "Всем параграфам на странице установите максимальную ширину <code>600px</code>. Измените ширину окна браузера и убедитесь, что ширина параграфов не превышает это значение.",
        ...
        },
        {
          id: 2,
          label:
            "Всем параграфам на странице установите максимальную высоту <code>700px</code>. В HTML редакторе в любом параграфе увеличьте количество текста (скопируйте и вставьте текст несколько раз) и убедитесь, что текст начинает вываливаться из параграфа.",
...

    {
      ...
      url: "css-overflow",
      theory: `<p>В прошлом упражнении мы увидели, что если контент не помещается в свою коробку, он вываливается за ее пределы. Это переполнение (overflow). Переполнение контентом может случиться как по ширине (если контента становится больше, чем вмещает контейнер по ширине), так и по высоте.</p>
<p>Свойство <code>overflow</code> позволяет контролировать то, как именно ведет себя элемент при переполнении контентом. Простое вываливание контента из контейнера редко является желательным поведением.</p>
...
<ul>
  <li><code>visible</code> - контент не обрезается и может вываливаться за пределы вмещающей коробки. Это поведение по умолчанию.</li>
  <li><code>hidden</code> - контент обрезается, часть контента, не вмещающаяся в свою коробку, становится невидимой.</li>
...
`,
      goal: `Измените поведение при переполнении контентом.`,
      initValues: {
        html: `<!--HTML редактор-->
...
.share a:hover {
  ...
  color: rgb(0, 188, 212);
      ...
      tasks: [
        {
          id: 1,
          label:
            "Элементу с классом <code>content</code> задайте фиксированную высоту <code>500px</code>. Обратите внимание, что верстка сломалась, так как произошло переполнение контентом.",
          testRegExp: [/.content\s+{[\s\S]*height: 500px;[\s\S]*}/],
...

    {
      ...
      url: "css-block",
      theory: `<p>Коробки (boxes), в которые заключены HTML элементы согласно коробочной модели могут быть нескольких типов. В основном до этого мы имели дело с <em>блочными</em> коробками (или, иначе, блочными элементами). Давайте повторим и закрепим основные свойства блочных элементов:</p>
<ul>
  <li>Каждый блочный элемент отображается на новой строке</li>
  <li>Блочный элемент растягивается по ширине и занимает 100% ширину родительского элемента если не указано иное правило</li>
  <li>Блочный элемент учитывает ширину и высоту</li>
  <li>Граница, а также внутренние и внешние отступы отталкивают другие элементы от блочного элемента</li>
</ul>

<p>Блочными элементами по умолчанию являются заголовки <code>h1-h6</code>, параграфы <code>p</code>, элементы списков <code>li</code>, все элементы, определяющие структуру страницы - <code>div</code>, <code>section</code>, <code>article</code>, <code>aside</code>, <code>header</code> и т.д.</p>
<p>Вы сожете также явно задать элементу отображение в виде блока с помощью свойства <code>display</code>:</p>
...
ul {
  list-style: none;
      ...
      tasks: [
        {
          id: 1,
          label:
            "Элементу с классом <code>block</code> задайте фиксированную высоту <code>50px</code>. Обратите внимание, что ничего не произошло, поскольку элемент <code>span</code> не является блочным по умолчанию.",
...

    {
      ...
      url: "css-inline",
      theory: `<p>В противоположность блочным коробкам (элементам) есть строчные (<em>inline</em>) элементы. Вот их основные свойства:</p>
<ul>
...
<p>Строчными элементами по умолчанию являются ссылки <code>a</code>, текстовые элементы <code>span</code>, элементы форм <code>input</code>, элементы для выделения в тексте <code>strong</code>, <code>em</code>, <code>i</code>, <code>b</code>, <code>small</code> и т.д.</p>
<p>Вы сожете также явно задать элементу отображение в строчном виде:</p>
  ...
  display: block;
      ...
      tasks: [
        ...
        },
        {
          id: 2,
          label:
            "Теперь задайте этим элементам строчное отображение. Обратите внимание, что значение высоты теперь игнорируется.",
        ...
        },
        {
          id: 3,
          label:
            "Наконец, задайте этим элементам внешний отступ <code>3rem</code> со всех сторон. Убедитесь, что горизонтальный отступ действует, но соседние элементы игнорируют вертикальный отступ.",
...

    {
      ...
      theory: `<p>Наконец, есть способ расположить элементы в ряд как строчные, но и заставить их учитывать все свойства коробочной модели - ширину, высоту, границу и все отступы. Для этого элемент необходимо отразить блочно-строчным (<em>inline-block</em>), и тогда:</p>
<ul>
  ...
  margin: 3rem;
      ...
      tasks: [
        ...
        },
        {
          id: 2,
          label:
            "Теперь задайте этим элементам блочно-строчное отображение. Обратите внимание, что высота по прежнему учитывается.",
        ...
        },
        {
          id: 3,
          label:
            "Наконец, задайте этим элементам внешний отступ <code>2rem</code> со всех сторон. Убедитесь, что в этот раз все отступы учитываются.",
...

    {
      ...
      url: "css-content-box",
      theory: `<p>Последний важный аспект коробочной модели - как именно расчитывается место, которое элемент занимает на странице. Вернемся к примеру из предыдущего упражнения:</p>
...
<p style="box-sizing: content-box; margin: 25px 10px; padding: 10px 30px; color: red; width: 250px; height: 120px; background-color: #9abfe2; border: 5px solid #fff4c3;">Это контент элемента шириной 250px + рамка 10px + внутренний отступ 60px + внешний отступ 20px</p>
<p>Свойство <code>width</code> задает только ширину <em>контентной области</em>, а все остальные элементы коробки - границы и отступы, надо считать отдельно. Таким образом, общее место, которое займет на странице элемент составит 250px + 60px (паддинги) + 10px (рамка) + 20px (маргины) = 340px.</p>
...
<p>Тип коробочной модели управляется свойством <code>box-sizing</code>.</p>
  ...
  padding: 20px;
      ...
      tasks: [
        ...
        },
        {
          id: 2,
          label:
            "Элементу с классом <code>child</code> самостоятельно рассчитайте и установите фиксированную ширину таким образом, чтобы он не выходил за пределы родителя с учетом контентной модели коробки.",
          testRegExp: [/.child\s+{[\s\S]*width: 440px;[\s\S]*}/],
          failMsg:
            "Убедитесь, что вы подобрали правильное значение width. Не забывайте, что у элемента есть border и padding",
        },
      ],
    },
...
<p style="margin: 25px 10px; padding: 10px 30px; color: red; width: 250px; height: 120px; background-color: #9abfe2; border: 5px solid #fff4c3;">Это контент элемента шириной 250px + рамка 10px + внутренний отступ 60px + внешний отступ 20px</p>
...
<p>Можно возразить, что если при контентной модели коробки мы, зная ширину контента, должны были арифметически рассчитывать общую ширину элемента, то теперь наоборот, зная общую ширину элемента, должны вычитать рамку и паддинги, чтобы добраться до ширины контента. Это так, но по факту ширина контента в отрыве от остальных составляющих коробки мало кого интересыет.</p>
...
`,
      goal: `Измените тип коробочной модели.`,
      initValues: {
        html: `<!--HTML редактор-->
...
.child {
  ...
  padding: 20px;
      ...
      tasks: [
        {
          id: 1,
          label: "Установите всем элементам на странице рамочную коробочную модель.",
        ...
        },
        {
          id: 2,
          label:
            "Элементу с классом <code>child</code> измените ширину таким образом, чтобы он всегда занимал 100% своего родителя.",
