      ...
      tasks: [
        {
          id: 1,
          label:
            "Блоку с классом <code>share</code> задайте рамку сплошной линией толщиной 3px цвета rgb(0, 188, 212).",
  ...
  color: rgb(0, 188, 212);
      ...
      tasks: [
        ...
        },
        {
          id: 2,
          label:
            "Заголовку первого уровня, вложенному в <code>header-wrapper</code> задайте паддинги в сокращенной форме.",
  ...
  color: rgb(0, 188, 212);
      ...
      tasks: [
        ...
        },
        {
          id: 2,
          label:
            "Центрируйте блок с классом <code>content</code>.",
  ...
  color: rgb(0, 188, 212);
      ...
      tasks: [
        ...
        },
        {
          id: 2,
          label:
            "Всем параграфам на странице установите минимальную высоту <code>100px</code>. В HTML редакторе создайте еще один параграф с любым текстом и убедитесь, что минимальная высота работает.",
      ...
      tasks: [
        {
          id: 1,
          label:
            "Элементу с классом <code>content</code> задайте фиксированную высоту <code>400px</code>. Обратите внимание, что верстка сломалась, так как произошло переполнение контентом.",
  ...
  padding: 20px;
      ...
      tasks: [
        ...
        },
        {
          id: 2,
          label:
            "Элементу с классом <code>child</code> самостоятельно рассчитайте и установите фиксированную ширину таким образом, чтобы он не выходил за пределы родителя с учетом контентной модели.",
